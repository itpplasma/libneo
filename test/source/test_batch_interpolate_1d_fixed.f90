program test_batch_interpolate_1d_fixed
   ...
   use batch_interpolate_1d, only: evaluate_batch_spline_1d_scalar_quintic_der, &
   ...
   call make_polynomial_spline(scalar_spl, 1, .false.)
   ...
   call make_polynomial_spline(pair_spl, 2, .true.)
   ...
   print *, "PASSED: fixed quintic 1D evaluators satisfy polynomial oracle"

contains

   subroutine make_polynomial_spline(spl, nq, periodic)
