...
function compute_cylindrical_divb(field, x, tol) result(divb)
    use neo_field_base, only: field_t
    ...
    divb = dB_dx(1) + B(1)/x(1) + 1/x(1) * dB_dx(2) + dB_dx(3)
end function compute_cylindrical_divb
