...
import imp
#dd_alex=imp.load_source("dd",'/afs/ipp/home/a/aleb/lib/python/eqi_map/lib/dd.py')
#kk=imp.load_source("kk",'/afs/ipp/home/a/aleb/lib/python/eqi_map/lib/kk.py')
import dd_20140715 as dd
...
class eqi_map:
    ...
    def remapFromPFS(self,shot,tin,rho,quantity,diag='EQH', exp='AUGD', ed=0,rho_lbl='rho_pol'):
        ...
        shot: int
            number of the mapped shot
        quantity: str
            name of the quantity, like  Qpsi, B2ave,...
        diag: str
            diagnsotics used for mapping (EQI,EQH,...)
        exp: str
            experiment (AUGD)
