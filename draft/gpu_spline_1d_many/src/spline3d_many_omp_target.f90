module spline3d_many_omp_target
    use, intrinsic :: iso_fortran_env, only: dp => real64
    implicit none
    private

    public :: spline3d_many_omp_target_eval_resident

contains

    subroutine spline3d_many_omp_target_eval_resident(order, num_points, &
                                                      num_quantities, &
...
#include "spline3d_many_eval_body.inc"
    end subroutine spline3d_many_omp_target_eval_resident

end module spline3d_many_omp_target
