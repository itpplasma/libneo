module spline2d_many_cpu
    use, intrinsic :: iso_fortran_env, only: dp => real64
    implicit none
    private

    public :: spline2d_many_cpu_eval

contains

    pure subroutine spline2d_many_cpu_eval(order, num_points, num_quantities, &
                                           periodic, x_min, &
                                           h_step, coeff, x, y)
...
#include "spline2d_many_eval_body.inc"
    end subroutine spline2d_many_cpu_eval

end module spline2d_many_cpu
